...
次のどちらかに当たる図は画像にする。当たらない図は Mermaid にする。

1. Mermaid に対応する記法が無い（散布図、積み上げグラフ、注釈付き画像、写真、スクリーンショット）
2. 次の5条件のうち2つ以上を満たす
   - 境界、環境帯、スイムレーンのように、要素の位置そのものが意味を持つ
   - 凡例、Scope、前提、対象外、版を図と一体で読ませる
   - 線の経路や交差回避、ノードの整列が読みやすさを左右する
   - 手動ゲート、戻りループ、監視経路のように、線種と図形を同時に区別する
