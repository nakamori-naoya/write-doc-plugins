...
<!-- 執筆指示: 冒頭の一文で、いま損なわれている価値がどんな未来へ変わるかを言い切る。
     現状、課題、目指す状態、判断、根拠の流れは作るが、現在の障害に対する基本方針、資源配分、期限つき行動はProduct Strategyへ委ねる。
     「プロダクトの役割」「やらないこと」は事業上の選択であり、文書が扱わない内容の説明で埋めない。
     表現形式は固定しない。意味のある小見出しと短い本文を基本にし、正確な対応を示す場合は箇条書きや表を使う。
...
**言い切り**: <誰の、どんな不利益や不自由を、どんな価値ある状態へ変えるのか>
...
<!-- この図は、対象・損なわれた価値・プロダクトの役割・望む状態がひと続きにつながることを短時間で確かめるためのもの。
     図が指す概念はここまでで全て本文に出ているので、役割の節より前へ置かない。
...
<!-- この図は、担う範囲・他者が担う範囲・担う範囲の内側で採らない方針・境界で使う判断原則の4つを一枚で確かめるためのもの。
     「やらないこと」は他者の責任ではないので、担わない範囲と同じ区画へ混ぜない。
