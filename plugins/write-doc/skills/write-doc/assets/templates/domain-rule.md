...
<!-- 執筆指示: 作りを全部やめても残る業務の決まりを、業務の言葉と、この資料で名前を一つに決めた語（ユビキタス言語）だけで書く。
     ...
     見出しで構造を作り、決まりとその理由は段落の文章で書く。決まりの理由や背景は箇条書きや表にしない。一つの決まりは一か所にだけ書く。
...
<!-- ユビキタス言語の表、状態遷移図、BDDの見出しの形は、write-doc の公開契約の「検査が読む目印」が domain-rule について定める。見出しの文言は検査が読まない。 -->
